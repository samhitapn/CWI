...
for seq1, seq2 in itertools.combinations(sequences, 2):
    ...
    alignment[pairCount] = sequences[seq1].id + "," + sequences[seq2].id + "," + al[0][0] + "," + sequences[seq1].letter_annotations["phred_quality"] + "," + al[0][1] +  "," + str(sequences[seq2].letter_annotations["phred_quality"])
